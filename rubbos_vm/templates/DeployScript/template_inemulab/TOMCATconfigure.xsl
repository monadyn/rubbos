...
<file>
<xsl:text disable-output-escaping="yes">&lt;name id=&quot;</xsl:text>server.xml-<xsl:value-of select="./target"/>.<xsl:value-of select="//params/env/param[@name='EMULAB_EXPERIMENT_NAME']/@value"/><xsl:text disable-output-escaping="yes">&quot; loc=&quot;</xsl:text><xsl:value-of select="//params/env/param[@name='OUTPUT_HOME']/@value"/>/tomcat_conf<xsl:text disable-output-escaping="yes">&quot;/&gt;</xsl:text>
<content>
