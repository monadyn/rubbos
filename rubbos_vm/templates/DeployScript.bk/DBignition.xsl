...
<xsl:template match="//argshere[@id='DB_ignition.sh' and @type='current']"> &amp; sleep 5; </xsl:template>

<xsl:template match="//argshere[@id='DB_ignition.sh' and @type='pre-action']">
<xsl:text> 
</xsl:text>
</xsl:template>


<xsl:template match="//argshere[@id='DB_ignition.sh' and @type='post-action']"> 
<xsl:text> 
</xsl:text>
</xsl:template>
