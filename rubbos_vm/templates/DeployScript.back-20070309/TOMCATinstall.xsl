...
if [ -e $RUBIS_TOP/rubis-deploy-log.txt ] &amp;&amp; grep -q "AppServer installed successfully" $RUBIS_TOP/rubis-deploy-log.txt
then

echo " "
echo "**** Previously installed App Server detected !!! *******"
echo "**** skipping App Server installation ********************"
echo " "
...
echo "[STATUS]: AppServer installed successfully" >> $RUBIS_TOP/rubis-deploy-log-tmp.txt
