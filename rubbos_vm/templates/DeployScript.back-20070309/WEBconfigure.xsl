...
if [ -e $RUBIS_TOP/rubis-deploy-log.txt ] &amp;&amp; grep -q "Apache configured successfully" $RUBIS_TOP/rubis-deploy-log.txt 
then

echo " "
echo "***** Previously configured Apache detected!!! *******"
echo " "
...
cd $RUBIS_TOP/jakarta-tomcat-connectors-jk2-2.0.4-src/jk/native2
...
echo "[STATUS]: Apache configured successfully" >> $RUBIS_TOP/rubis-deploy-log-tmp.txt
mv $RUBIS_TOP/rubis-deploy-log-tmp.txt $RUBIS_TOP/rubis-deploy-log.txt
