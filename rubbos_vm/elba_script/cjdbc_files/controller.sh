...
#JVM_OPTIONS="-Xloggc:$CJDBC_HOME/log/cjdbc_`/home/qywang/date_time.prl`_`hostname`_gc.log -XX:+PrintGCTimeStamps -Xmn1050M -Xms1300M  -Xmx1300M -Dcom.sun.management.jmxremote.port=2099 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false "
JVM_OPTIONS="-Xloggc:$CJDBC_HOME/log/cjdbc_`/home/qywang/date_time.prl`_`hostname`_gc.log -XX:+PrintGCTimeStamps -Xms1300M  -Xmx1300M -Dcom.sun.management.jmxremote.port=2099 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false "
...
# Java Command.
/mnt/local_disk/softwares/jdk1.6.0_23/bin/java $JVM_OPTIONS -classpath $CLASSPATH  -Dcjdbc.home=$CJDBC_HOME  -Dcjdbc.log=$CJDBC_LOG  -Djava.security.policy=$CJDBC_HOME/config/java.policy org.objectweb.cjdbc.controller.core.Controller  "$@"
